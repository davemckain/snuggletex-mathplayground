...
public final class LaTeXInputServlet extends BaseServlet {
    ...
    private String[] pipelineMathML(SnuggleSession session, DOMOutputOptions options) {
        ...
        Element temporaryRoot = pmathmlDocument.createElementNS(W3CConstants.MATHML_NAMESPACE, "temp");
    ...
    protected Document callUpconversionMethod(MathMLUpConverter upconverter, Document pmathmlDocument) {
        UpConversionOptions upConversionOptions = new UpConversionOptions(); /* FIXME: Using defaults here! */
        return upconverter.upConvertSnuggleTeXMathML(pmathmlDocument, upConversionOptions);
    }
}
